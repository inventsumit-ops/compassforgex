            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="bg-card border border-border rounded-xl p-6">
                  ...
                  <ul className="space-y-3 text-muted-foreground">
                    <li className="flex items-start">
                      <span className="w-2 h-2 bg-red-600 rounded-full mr-3 mt-1.5 shrink-0"></span>
                      <div>
                ...
                <div className="bg-card border border-border rounded-xl p-6">
                  ...
                  <ul className="space-y-3 text-muted-foreground">
                    <li className="flex items-start">
                      <span className="w-2 h-2 bg-orange-600 rounded-full mr-3 mt-1.5 shrink-0"></span>
                      <div>
                ...
                <div className="bg-card border border-border rounded-xl p-6">
                  ...
                  <ul className="space-y-3 text-muted-foreground">
                    <li className="flex items-start">
                      <span className="w-2 h-2 bg-yellow-600 rounded-full mr-3 mt-1.5 shrink-0"></span>
                      <div>
                ...
                <div className="bg-card border border-border rounded-xl p-6">
                  ...
                  <ul className="space-y-3 text-muted-foreground">
                    <li className="flex items-start">
                      <span className="w-2 h-2 bg-blue-600 rounded-full mr-3 mt-1.5 shrink-0"></span>
                      <div>
